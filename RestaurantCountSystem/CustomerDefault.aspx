<%@ Page Title="" Language="C#" MasterPageFile="~/CustomerSiteMaster.Master" AutoEventWireup="true" CodeBehind="CustomerDefault.aspx.cs" Inherits="RestaurantCountSystem.CustomerDefault" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      <div class="defaultpage">
        ...
        <asp:Button ID="Button7" runat="server" Text="▼確認桌號" OnClick="Button7_Click" class="MainButtonStyle"/>
                          </div>
  <!-- 點餐選單以下 -->
        <div class="DefaultOtherBlock">
            <div class="MainWordBlock">
       ...
       <div>
        ...
        <div id="RicePlace" runat="server">
           ...
           <div id="DriedNoodlePlace" runat="server">
            ...
            <asp:Button ID="menu54" runat="server" Text="豆干(2個)-20"  class="MenuStyle" OnClick="menu54_Click"/>
  ...
  <!-- 點餐選單以上 -->
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConflictDetection="CompareAllValues"
            ...
            <InsertParameters>
                ...
                <asp:ControlParameter ControlID="TextBox1" DefaultValue="" Name="數量" PropertyName="Text" Type="Int32" />
                ...
                <asp:Parameter Name="是否出餐" Type="Boolean" DefaultValue="false" />
      ...
      <p class="MainWord">目前餐點</p>
        <asp:Button ID="DeleteMenu" runat="server" Text="▼顯示餐點" OnClick="DeleteMenu_Click" class="MainButtonStyle" />
             ...
             <iframe src="CustomerCheck1.aspx" width="auto" height="auto" frameborder="0" scrolling="true">
